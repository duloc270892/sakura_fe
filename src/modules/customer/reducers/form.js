...
const INITIAL_STATE = {
    ...
    listHeaderTable: [
        ...
        { key: 'Name', title: 'Tên khách hàng', type: 'text', class: '', valueFilter: '' },
        { key: 'Phone', title: 'Tem hiệu khách', type: 'text', class: '', valueFilter: '' },
        { key: 'IdentifyCardNumber', title: 'Card number', type: 'text', class: '', valueFilter: '' },
        { key: 'Discount', title: 'Discount', type: 'text', class: '', valueFilter: '' },
        { key: 'CodeLH', title: 'Loại hội', type: 'text', class: '', valueFilter: '' },
        { key: 'CodeMX', title: 'Màu xi', type: 'text', class: '', valueFilter: '' },
        { key: 'CodeLAI', title: 'Lai', type: 'text', class: '', valueFilter: '' },
        { key: 'CodeLV', title: 'Loại vàng', type: 'text', class: '', valueFilter: '' },
    ],
    ...
    listHeaderTabCasting: [
        ...
        { key: 'SL', title: 'Tên khách hàng', type: 'text', class: '', valueFilter: '' },
        { key: 'DELETE', title: 'Số điện thoại', type: 'text', class: '', valueFilter: '' },
        { key: 'DELETE', title: 'Card number', type: 'text', class: '', valueFilter: '' },
        { key: 'DISCO', title: 'Discount', type: 'text', class: '', valueFilter: '' },
    ],
    listStoneSelected: [],
    objData: {
        Id: '',
