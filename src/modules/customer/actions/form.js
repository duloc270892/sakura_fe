...
export const getListDataBaoGiaInCustomer = (params = { page: 1, total: 50 }) => {
...
export const getListDataCustomer = (params = { page: 1, total: 50 }) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
...
export const getListDataCustomerSearch = (params = { page: 1, total: 50, key: '', value: '' }) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
