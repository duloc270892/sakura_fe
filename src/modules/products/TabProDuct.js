...
class TabProDuct extends React.Component {
    ...
    render() {
        let { IdProductSeach, Id, IdOdd, CodeMpm, CodeLv, CodeLh
            , Weight, Price, WeightReal, WeightProduct, Details, Tags, Public, Remark, Resin, CodeKc, Unit, IdNew, Name, Status } = this.props.products.objData
        let { status } = this.props.toolbar
        return (
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <div className="right">
                                <input className="name form-control allownumericwithdecimal"
                                    value={Price} onChange={(e) => this._onChange(e)} type="text" id="Price" name="name" required="" /><span className="wpcf-not-valid-tip wpcf-display-none" ></span>
                            </div>
                        </div>
                    </div>
                </div>
