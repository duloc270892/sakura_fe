...
class CreateBagFromView extends React.Component {
    ...
    saveBag() {
        ...
        let { listItemCreateBag, selectedOrder, itemDetail, list_stone_save, listItemCreateBagDefault,
            list_stone_save_split, list_stone_save_split_custom, itemDetailCreateBag, isNew, split_odd, IdBagCreate, isLoadingBag } = this.props.bag
        if (!isLoadingBag) {
        ...
        if (isLoadingBag) {
            ...
            if (split_odd) {
                ...
                console.log('IdBagCreate', IdBagCreate);
                if (IdBagCreate) {
