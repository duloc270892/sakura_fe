...
export const clickRowDataCreateBag = (obj) => {
    return (dispatch, getState) => {
        var objTemp = _.clone(obj, true)
        dispatch({
            type: CLICK_ROW_CREATE_BAG,
            payload: {
                itemDetailCreateBag: objTemp
            }
        })
    }
}
...
export const updateIdChildrenProduct = (obj) => {
    return (dispatch, getState) => {
        ...
        let objTemp = _.clone(obj, true)
        //IdProductParent: IdProductParent, IdProductChildren:
        temp.map((item, i) => {
            if (item.IdProduct == objTemp.IdParent && item.Color == objTemp.Color) {
                item["IdChildrenProduct"] = objTemp.IdProductChildren
...
export const updateIdChildrenProductDetail = (obj) => {
    return (dispatch, getState) => {
        ...
        listItemCreateBag_temp.map((item) => {
            if (item.Color == objTemp.Color) {
                item.IdChildrenProduct = objTemp.IdProductChildren
            }
            return item
        })
        itemDetailCreateBag_temp.IdChildrenProduct = objTemp.IdProductChildren
...
export const updatePrimaryStone = (itemCheck, checkval) => {
    return (dispatch, getState) => {
        ...
        let list_stone_save_temp = _.clone(list_stone_save, true);
        let itemCheckClone = _.clone(itemCheck, true)
        // nếu là sản phẩm  lẻ
        if (itemDetailCreateBag.IdOdd != "1") {

            list_stone_save_temp.map((item, i) => {
                let { IdStone, IdProduct, IdProductParent, ColorParent } = item
                if (checkval == false && (item.IdBagIdProductIdStone == itemCheckClone.IdBagIdProductIdSton ||
                    item.IdProductParentIdProductStone == itemCheckClone.IdProductParentIdProductStone)) {
                    item.PrimaryStone = 0
                    item.Color = '001'
                    item.Weight = ''
                    item.AvgStone = 0
                ...
                else if (item.IdBagIdProductIdStone == itemCheckClone.IdBagIdProductIdStone ||
                    item.IdProductParentIdProductStone == itemCheckClone.IdProductParentIdProductStone) {
                    if (item.IdBagIdProductIdStone == itemCheckClone.IdBagIdProductIdStone) {
                        item.PrimaryStone = 1
...
export const updateTypeSplitStone = (objTemp) => {
...
export const updateTypeBag = (objTemp) => {
    let obj = _.clone(objTemp, true)
    let { other } = obj
    return (dispatch, getState) => {
        let { listItemCreateBag } = getState().bag
...
export const updateCellBag = (objTemp) => {
    let obj = _.clone(objTemp, true)
    let { other } = obj
    return (dispatch, getState) => {
        let { listItemCreateBag, list_stone_save } = getState().bag
...
export const updateIdProductColor = (objTemp) => {
    let obj = _.clone(objTemp, true)
    return (dispatch, getState) => {
...
export const updateTypeStoneByStone = (objTemp) => {
    let obj = _.clone(objTemp, true)
    return (dispatch, getState) => {
        let { list_stone_save } = getState().bag
        let temp = _.clone(list_stone_save, true);
...
export const updateTypeStoneByStoneSplit = (objTemp) => {
    return (dispatch, getState) => {
        let obj = _.clone(objTemp, true)
...
export const updateCellStone = (objTemp) => {
    return (dispatch, getState) => {
        let obj = _.clone(objTemp, true)
...
export const updateCellStoneSplit = (objTemp) => {
    return (dispatch, getState) => {
        let obj = _.clone(objTemp, true)
...
export const removeProductsInListBag = (obj) => {
    return (dispatch, getState) => {
        ...
        let data_temp = listItemCreateBagClone.filter(x => x.IdProduct != obj.IdProduct)
        let list_stone_save_temp = list_stone_saveClone.filter(x => x.IdProduct != obj.IdProduct)
        dispatch({
...
export const updateStatusBagNotSplit = (obj, status) => {
    return (dispatch, getState) => {
        ...
        let listItemCreateBagClone = _.clone(listItemCreateBag, true)
        let ListProductByOrderInBagClone = _.clone(ListProductByOrderInBag, true)
        ...
        return new Promise((resolve, rejects) => {
            axios.post(`${Config.API_URL_USER}bag/update_status_split_bag`,
                ...
                .then((response) => {
                    ...
                    if (data.length > 0) {
                        listItemCreateBagClone = data
                    }
                    ListProductByOrderInBagClone.map((item) => {
                    ...
                    listItemCreateBagClone.map(x => x.SplitBag = status)
                    listItemCreateBagClone.map(x => x.IdProductParent = obj.IdProduct)

                    dispatch({
                        type: UPDATE_SPLIT_BAG,
                        payload: {
                            listItemCreateBag: listItemCreateBagClone,
                            ListProductByOrderInBag: ListProductByOrderInBagClone
                        }
                    })
                    resolve(response)
                }, (err) => {
...
export const updateStatusSplitOdd = (listDataTemp, status) => {
    return (dispatch, getState) => new Promise((resolve, reject) => {
        let listAPI = []
        let listData = _.clone(listDataTemp, true)
        listData.map((obj) => {
            listAPI.push(
                axios.post(`${Config.API_URL_USER}bag/update_status_split_bag`,
                    {
...
export const clickCheckRowOrderInBag = (objTemp, checked) => {
    return (dispatch, getState) => {
        let obj = _.clone(objTemp, true)
...
export const UpdateBagList = (StatusWeight) => {
    return (dispatch, getState) => {
        ...
        let listItemCreateBag_temp = _.clone(listItemCreateBag, true)
        let list_stone_saveClone = _.clone(list_stone_save, true)
        let list_stone_save_splitClone = _.clone(list_stone_save_split, true)
        let list_stone_save_split_customClone = _.clone(list_stone_save_split_custom, true)
        ...
        listItemCreateBag_temp.map((item, i) => {
            ...
            if (item.IdOdd == "1") {
                if (i == 0) {
                    list_stone_saveClone.map((item2) => {
                    ...
                    list_stone_save_splitClone.map((item2) => {
                        let itemInfo = listItemCreateBag_temp.filter(x => x.IdProduct + x.ColorParent == item2.IdProductParent + item2.ColorParent)
                        if (itemInfo && itemInfo[0]) {
                            let item_data = _.clone(item2, true)
                            item_data.qty = parseFloat(itemInfo[0].ProductsEachBag)
                    ...
                    list_stone_save_split_customClone.map((item2) => {
                        let itemInfo = listItemCreateBag_temp.filter(x => x.IdProduct + x.ColorParent == item2.IdProductParent + item2.ColorParent)
                        if (itemInfo && itemInfo[0]) {
                            let item_data = _.clone(item2, true)
                            item_data.qty = parseFloat(itemInfo[0].ProductsEachBag)
        ...
        listItemCreateBag_temp.map(x => x.created_by = username)
        list_stone_save_temp.map(x => x.created_by = username)
        list_stone_split_save_temp.map(x => x.created_by = username)
...
export const InsertBagListSplitOdd = (listInsertBagTemp) => {
    let listInsertBag = _.clone(listInsertBagTemp, true)
    return (dispatch, getState) => {
        dispatch({
            type: LOADING_BAG,
            payload: {
        ...
        listInsertBag.map((itemBag, ib) => {
            ...
            //update is split
            list_stone_save_temp = list_stone_save_temp.map((item) => {
                let check = list_stone_save_splitClone.filter(x => x.IdProductColorParentColorStone == item.IdProductColorParentColorStone)
                if (check.length > 0) {
                    item.issplit = 1
                } else {
                    item.issplit = 0
            ...
            let username = oldUserInfo && oldUserInfo.user_name || ''
            listItemCreateBag.map(x => x.created_by = username)
            list_stone_save_temp.map(x => x.created_by = username)
            list_stone_split_save_temp.map(x => x.created_by = username)
...
export const InsertBagList = (listItemCreateBagTemp) => {
    let listItemCreateBag = _.clone(listItemCreateBagTemp, true)
    return (dispatch, getState) => {
        dispatch({
            type: LOADING_BAG,
            payload: {
...
export const getNumberAutoBag = () => {
    return (dispatch, getState) => {
        ...
        let listItemCreateBagClone = _.clone(listItemCreateBag, true)
        let itemDetailBag = listItemCreateBagClone && listItemCreateBagClone[0]
        return new Promise((resolve, reject) => {
            Promise.all([
                axios.get(`${Config.API_URL_USER}bag/get_auto_number`),
        ...
        return new Promise((resolve, reject) => {
            Promise.all([
                ...
                .then((response) => {
                    ...
                    let list_temp_all = []
                    let listColor = []
                    listItemCreateBagDefaultClone.map((item) => {
...
export const getListStoneByProductsInBagSplit = (list_dataTemp) => {
    let list_data = _.clone(list_dataTemp, true)
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
...
export const getListStoneByProductsInBagDefault = (list_dataTemp, listItemCreateBagTemp) => {
    let listItemCreateBag = _.clone(listItemCreateBagTemp, true)
    let list_data = _.clone(list_dataTemp, true)
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
...
export const getListStoneByProductsInBagNew = (list_dataTemp, listItemCreateBagTemp) => {
    let listItemCreateBag = _.clone(listItemCreateBagTemp, true)
    let list_data = _.clone(list_dataTemp, true)
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
...
export const getListStoneByProductsInBag = (objTemp, list_dataTemp, sttOdd = 0) => {
    let obj = _.clone(objTemp, true)
    let list_data = _.clone(list_dataTemp, true)
...
export const getListProductsByOrderSplitBag = (objTemp, qty = 0) => {
    let obj = _.clone(objTemp, true)
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
