...
class TabProduct extends React.Component {
    ...
    _loadData() {
        ...
        if (objDataOrder.IdOrder) {
            this.props.getListProductByOrder()
        }
    ...
    _onKeyPressCheckProduct(e, IdProduct, index) {
        ...
        if (e.key == 'Enter') {
            ...
            console.log('check',list_products);
                    ...
                    <tbody id="table_product">
                        {listProductsSelected && listProductsSelected.map((item, i) => {
                            let { stt, value, url_image, color, size, Weight, WeightReal,
                                ...
                                sum_basic, isExists, index, remark, Image } = item
                                ...
                                <tr key={`data_${i}`} id={`tr_${index}`}>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            readOnly={isEditProducts == 'block' ? true : false}
                                            id={index}
                                            style={{ "width": `100px` }}
                                    ...
                                    <Cell index={index} width="60px" readOnly={isEditProducts == 'block' ? true : isExists ? false : true} value={sl} keyInput="sl" id={index} parentObject={this} />
                                    <td>
                                        <Combobox disable={isEditProducts == 'block' ? true : false}
                                    ...
                                    <td>
                                        <input
                                            ...
                                            readOnly={isEditProducts == 'block' ? true : isExists ? false : true}
                                            id={index}
                                            style={{ "width": `180px` }}
                                            className={`name form-control`}
                                            type='text'
                                        ...
                                        {IdOdd == "1" ? <div onMouseEnter={() => this._onView(item)} >
                                            ...
                                            <ReactTooltip id='global' aria-haspopup='true' role='example'>
                                                ...
                                                <table >
                                                    ...
                                                    <tbody>
                                                        {list_set.length > 0 && list_set.map((item, i) => {
                                                            let { Id, Price } = item
                                                            return (
