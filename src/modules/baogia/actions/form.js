...
export const getListProductByPriceReport = (obj) => {
    return (dispatch, getState) => {
        let { listProductsSelected } = getState().order
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}baogia/get_list_product_by_price_report`, { params: { Pricecode: obj.Pricecode } })
                .then((response) => {
...
export const printBaoGiaDetail = (item) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.post(`${Config.API_URL_USER}baogia/print_detail_baogia`,
                { Pricecode: item.Pricecode, Info: item },
                {
                ...
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', `Bảng giá_${item.Pricecode}`); //or any other extension
...
export const exportListBangGia = (value = '') => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.post(`${Config.API_URL_USER}baogia/export_data`,
                ...
                .then((response) => {
                    ...
                    const link = document.createElement('a');
                    link.href = url;
                    link.setAttribute('download', 'Danh sách bảng giá.xlsx'); //or any other extension
                    document.body.appendChild(link);
                    link.click();
                    resolve(response)
                }, (err) => {
...
export const getListDataBaoGia = (params = { page: 1, total: 50 }) => {
    return (dispatch, getState) => {
...
export const getListDataBySearch = (value) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}baogia/search`, { params: { page: 1, total: 50, key: value } })
                .then((response) => {
                    let { data } = response.data
                    let data_temp = data
                    data_temp.map(item => item.checked = false)
...
export const getListDataProductInBaoGia = (params = { page: 1, total: 50 }) => {
    return (dispatch, getState) => {
