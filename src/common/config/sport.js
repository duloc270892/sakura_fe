const sportConfig = {
    ...
    listLogo: [
        { host: 'localhost', logo: '/images/logo.png', class: 'logo', title: '7Sports.co' },
        { host: '7sports', logo: '/images/logo.png', class: 'logo', title: '7Sports.co' },
        { host: 'tujuh', logo: '/images/logo_Tujuh.png', class: 'logo tujuh', title: 'Tujuh Sports' },
        { host: 'klik7', logo: '/images/logo_Klik.png', class: 'logo klik', title: 'Klik7 Sports' }
    ],
    listIcon: [
...
sportConfig.function = {
    ...
    countEvent({ market, listToday, listLive, listEarly, eventCount, sport }) {
        ...
        switch (market) {
            case 0:
                //update for today
                const eventToday = _countEvent({ market: 0, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][0] &&
                    eventCount[sport][0]) {
            ...
            case 1:
                //update for live
                const eventLive = _countEvent({ market: 1, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][0] &&
                    eventCount[sport][0]) {
            ...
            case 2:
                //update for early
                const eventEarly = _countEvent({ market: 2, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][0] &&
                    eventCount[sport][0]) {
            ...
            case 3:
                //update money line
                const eventMoneyLine = _countEvent({ market: 3, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][4] &&
                    eventCount[sport][4]) {
            ...
            case 4:
                //update for outright
                const eventOutright = _countEvent({ market: 4, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][2] &&
                    eventCount[sport][2]) {
            ...
            case 5:
                //update for OETG
                const eventOETG = _countEvent({ market: 5, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][3] &&
                    eventCount[sport][3]) {
            ...
            case 6:
                //update for FTFHCS
                const eventFTFHCS = _countEvent({ market: 6, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][5] &&
                    eventCount[sport][5]) {
            ...
            case 7:
                //update for parlay
                const eventParlay = _countEvent({ market: 7, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][1] &&
                    eventCount[sport][1]) {
            ...
            case 8:
                //update for HT FT
                const eventHTFT = _countEvent({ market: 8, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][6] &&
                    eventCount[sport][6]) {
            ...
            case 9:
                //update for FG LG
                const eventFGLG = _countEvent({ market: 9, listLive: listLive, listToday: listToday, listEarly: listEarly })
                if (eventCount &&
                    eventCount[sport] &&
                    eventCount[sport][7] &&
                    eventCount[sport][7]) {
...
sportConfig.function.roundOdds = function (odds) {
    ...
    if (odds) {
        oriOdds = odds
        subOdds = parseFloat(oriOdds.toString().substring(0, oriOdds > 0 ? 5 : 6))
        if (oriOdds == subOdds) {
    ...
    switch (true) {
        ...
        case (objOdds.type != oddsEntry):
            switch (true) {
                ...
                case (objOdds.type != 0 &&
                    typeof sportConfig.function._parseOddsArray[objOdds.type][oddsEntry] != 'function'):
                    temp = sportConfig.function._parseOddsArray[0][oddsEntry](sportConfig.function._parseOddsArray[objOdds.type][0](objOdds.value))
                    return notRound == true ? temp : sportConfig.function.roundOdds(temp)
                case (objOdds.type != 0 &&
                    typeof sportConfig.function._parseOddsArray[objOdds.type][oddsEntry] == 'function'):
                    temp = sportConfig.function._parseOddsArray[objOdds.type][oddsEntry](objOdds.value)
...
sportConfig._getLogo = function () {
    ...
    var logo = (item && item.logo || '/images/logo.png') + '?v=' + Math.random()
    return logo
}
